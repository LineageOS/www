...
A more detailed explanation of the ramoops kernel feature will follow soon.
...
### dlopen failed
Many legacy devices have prebuilt libraries that are compiled with older versions of libraries that have dropped certain classes. An error that might occur will look something like this:
...
To solve such an error, we require interpolating libraries that we colloquially refer to as "shims".
