...
You should use regex to label an initiator. All file labels go into a single file named *file_contexts*. For example reference, please check [platform/system/sepolicy/private/file_contexts](https://android.googlesource.com/platform/system/sepolicy/+/refs/heads/master/private/file_contexts).
