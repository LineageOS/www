...
---
 ...
 ![hero]({{site.baseurl}}/images/engineering/hero_selinux.webp){: .blog_post_image }{: alt="A detailed set of glass-like facets create a the idea of a large passageway on a green background. Large lime green shapes, the Lineage logo, and the word Engineering sit on top."}
