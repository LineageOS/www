...
* [audit2allow](https://linux.die.net/man/1/audit2allow): Generates SELinux policy containing allow & dontaudit rules. Doesn't covers neverallow exceptions.
...
* [selinuxproject](https://selinuxproject.org/page/Main_Page)
