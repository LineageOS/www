...
The decoder (located inside the playback device) is required to support any combination of these parameters, but the encoder (located inside the smartphone) may only implement them partially.
