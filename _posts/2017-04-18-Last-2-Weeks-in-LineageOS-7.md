...
### 7.1.2 Merge
We've merged up the N branch to 7.1.2. Builds starting April 14th will include these. This merge includes all AOSP security patches and features to the platform.
