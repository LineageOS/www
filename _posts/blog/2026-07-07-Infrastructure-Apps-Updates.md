...
author: Inhishonor and Nolen Johnson
---

![hero]({{site.baseurl}}/images/2026-07-07/hero.webp){: .blog_post_image_full }

## It's Summer (in the Northern Hemisphere at Least)

Hello again! We are trying to give more regular updates, in order to inform you of some changes to our infrastructure, our apps, and our security patching efforts. Over the past few months we have had many contributors tirelessly working on every aspect of the OS, as well as the infrastructure behind it, especially our contributor niclimcy who is responsible for many of the changes listed below.
...
The wiki is the source of truth when it comes to LineageOS, but it was also a source of temporary blindness! Thankfully, niclimcy has remedied this for us by adding built-in dark mode. And we must say, it looks very nice.
...
1. For LineageOS versions 21, 22, and 23; we are testing and merging patches from each monthly security bulletin as they are released by Google.
...
![LineageOS Security Patch Level by Branch]({{site.baseurl}}/images/2026-07-07/security-patch-level-by-branch.png){: .blog_post_image_full }
...
We also now [stream](https://source.android.com/docs/core/ota/ab#streaming-updates) A/B OTA update packages by default, so you'll notice both less space is necessary, and the updates apply much faster!

### The Future

We'll keep this one short - Google has [released Android 17](https://source.android.com/docs/whatsnew/android-17-release) to the public. Therefore, LineageOS 24 development is underway. As always, there will be no ETAs provided - but we are progressing nicely!
...
| The Fairphone (Gen. 6) | [FP6](https://wiki.lineageos.org/devices/FP6) | ArianK16a, mikeioannina |  |
...
| LG G6 (EU Unlocked - ENG BL) | [h870d](https://wiki.lineageos.org/devices/h870d) | npjohnson, Simex, basamaryan, Androbots, AShiningRay, ROMSG, Geel | 21 |
