...
![hero]({{site.baseurl}}/images/2019-07-01/hero.png){: .blog_post_image_full }
...
patron and help keep on infrastructure up and running. You can find our Patreon
page with all the information [here](https://www.patreon.com/LineageOS).
