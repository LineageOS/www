---
layout: post
title: Changelog 2 - Exemplary Eleven, Ravishing Recorder, UX, EMU (TV too), eTar, Seedvault, Recovery Updater
category: blog
...
* September, October, November, December 2020 and January, February, March 2020 security patches have been merged to LineageOS 15.1 through 18.1.
...
* WebView has been updated to Chromium 88.0.4324.152.
...
* There is now an option on non-A/B devices to update the recovery image alongside the OS, just as the stock OS would!
  * To use this, either enable the option in SetupWizard, or navigate to Settings -> System -> (Show More) Updater -> Three Dot Menu in the top right -> and check "Update recovery alongside OS".


### TODO: Deep dive a feature
