...
nightlies on February 25th. LineageOS 15.1 builds have been moved to weeklies as a result.
...
Additionally, certain devices will be built on multiple versions in order to allow builds on a newer branch for users who would like a newer version
