...
| Google Pixel 3 | [blueline](https://wiki.lineageos.org/devices/blueline) | rashed | |
| Google Pixel 3 XL | [crosshatch](https://wiki.lineageos.org/devices/crosshatch) | npjohnson, rashed | |
