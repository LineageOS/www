...
we are beginning with the ability to block new USB device connections when device is locked.
...
| Google Pixel 2 | [walleye](https://wiki.lineageos.org/devices/walleye) | rashed | |
