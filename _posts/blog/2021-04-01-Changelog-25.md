...
official builds for these targets, due to the fact the user-experience varies entirely based on how well the device manufacturer complied to Treble's
...
and Nolen Johnson (npjohnson) recently posted a comprehensive piece on working with SELinux on Android! Just about veryone can benefit from giving
it a read, it's written in a way that both aspiring, and seasoned developers will both learn something. You can read it [here](https://lineageos.org/engineering/HowTo-SELinux)!
