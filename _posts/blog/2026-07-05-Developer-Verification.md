...
Both things can be true at once: real fraud a problem and restriction of developers a convenient side effect of solving it this way - and we're not in a position to pretend we know Google's internal reasoning. We're just telling you what they've said and what it changes; you can weigh the "why" yourself.
...
We have not ever, nor do we intend to ever, ship GMS. That means we're not subject to the Google Test Suite (GTS) certification Google apps are required to pass. Therefore we have no obligation to install "AndroidDeveloperVerification" or point the afformentioned configurations (overlays) at it.
