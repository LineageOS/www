...
Welcome to LineageOS 23.1, based on Android 15 QPR1. Enjoy the new features, and, as always, happy flashing!

### New Features!

* Security patches from March 2024 to November 2024 have been merged to LineageOS 19.1 through 23.1.
...
from LineageOS 23.1 and onwards.
...
Starting from LineageOS 23.1, the OS will bundle a native reader app for PDF files which,
...
Overall, we feel that the 23.1 branch has reached feature and stability parity with 21 and is ready for initial release.
...
LineageOS 23.1 will launch building for a decent selection of devices, with additional devices to come as they are marked as both
