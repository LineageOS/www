---
layout: post
title: Changelog 27 - Thriving Thirteen, Miraculous Monet, Amazing Aperture, Careful Commonization 
category: blog
excerpt: X_X
...
written in large part by developers SebaUbuntu and Luk1337.
...
* `ohmagoditfinallyhappened` - LineageOS now has an awesome Camera app called Aperture! It is based on [Google's](https://developer.android.com/training/camerax) (mostly) awesome CameraX base and provides a much closer "to stock" camera app experience on many devices. Massive kudos to developers SebaUbuntu and Luk1337 who developed this initially, and to the entire team for working to integrate it into LineageOS and adapt it to our massive array of supported devices!
* WebView has been updated to Chromium 108.0.5359.79.
* We have brought back out completely redone volume panel introduced in Android 13 and have further developed our side pop-out expanding panel.
...
* We have contributed even more of changes and improvements back upstream to the [Seedvault](https://calyxinstitute.org/projects/seedvault-encrypted-backup-for-android) backup app.
...
* Our merge scripts have been largely overhauled, greatly simplifying the [Android Security Bulletin](https://source.android.com/docs/security/bulletin)) merge process, as well as makes supporting devices like Pixel devices that have full source releases much more streamlined.
...
* Out Setup Wizard has seen adaptation for Android 13, with new styling, and more seamless transitions/user-experience.

### Amazing Aperture

Seba/Luk, tell us about your awesome app ;)
...
You can check it out [here](https://github.com/LineageOS/android_hardware_lineage_compat) and contribute shims that you think other devices may be in-need of or add additional components to additional shims and compatibility layers provided via Gerrit!
