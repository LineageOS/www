...
![hero]({{site.baseurl}}/images/2019-06-15/hero.png){: .blog_post_image }
...
* The volume panel can now be relocated to the left if the device has the buttons on that side
...
* WebView has been updated to Chromium 74.0.3729.157 (both 16.0 and 15.1)
