...
Recently, we have made a renewed effort to support older versions back until Lineage 14, and while we can't guarantee complete (or even partial) security, we are doing our best to merge all the applicable patches so that if you choose to run these versions there is still some measure of protection.
