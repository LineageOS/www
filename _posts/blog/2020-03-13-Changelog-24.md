...
![hero]({{site.baseurl}}/images/2020-03-13/hero.png){: .blog_post_image_full }
...
Due to some current infrastructure limitations, we are shipping in two batches - first, legacy devices, and later on, more modern devices (specifically, those which support
verity/Android Verified Boot).
...
* The [Styles API](https://wiki.lineageos.org/sdk/api/styles.html), is now deprecated in favor of the afformentioned ThemePicker app.
