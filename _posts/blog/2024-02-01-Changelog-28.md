...
* The developer-kit (e.g. Radxa 0, ODROID C4, Jetson X1) experience has been heavily improved, with UI elements and settings that don't related to their more restricted hardware feature-set being hidden or tailored!

### Amazing Applications!

![aperture]({{site.baseurl}}/images/2022-12-31/aperture.png){: .blog_post_image_content }

It feels good to finally see some movement regarding platform applications, especially since [Google announced they will deprecate the AOSP dialer and messaging applications](https://android-review.googlesource.com/c/platform/packages/apps/Dialer/+/2613992), which could affect other AOSP apps in the future.
...
- Dropped Google encrypted search engine
