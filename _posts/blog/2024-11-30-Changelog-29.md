...
* Contributor demon0000 (Cosmin Tanislav) has reworked our extract utilities, heavily optimizing them. He was able to optimize most devices down from ~170 seconds to extract, all the way down to roughly ~30 seconds.
