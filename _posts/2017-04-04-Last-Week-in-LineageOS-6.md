...
* br0zip is a harmless just-for-fun app shipping on LineageOS 14.1 builds from 3rd April to 7th April (_Disclaimer: It does not actually produce functional ROMs)
...
* You can now choose _when_ to begin screen recording in our 'Recorder' app. Press record and a popup will be placed on screen, from which you can begin the recording.
