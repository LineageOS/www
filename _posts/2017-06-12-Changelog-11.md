...
* LG V20 ([AT&T](https://wiki.lineageos.org/devices/d910), [T-Mobile](https://wiki.lineageos.org/devices/d918), [Sprint](https://wiki.lineageos.org/devices/ls997) and [GSM Unlocked](https://wiki.lineageos.org/devices/us996))
  * Suspended until wiki instructions are updated
* [LG G Pad X (T-Mobile) - v521](https://wiki.lineageos.org/devices/v521)
  * Suspended until wiki instructions are updated
* [LG V20 (Verizon) - vs995](https://wiki.lineageos.org/devices/vs995)
  * Suspended until wiki instructions are updated
